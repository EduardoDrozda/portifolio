import { Header } from "@shared/shared/components";
    ...
    <>
      <section className="w-screen h-screen relative" id="#">
        <Image
          ...
          className="absolute w-full h-full object-cover opacity-50 -z-50"
          width={0}
          height={0}
        />
        ...
        <div className="w-full h-3/4 flex flex-1 justify-center items-center">
